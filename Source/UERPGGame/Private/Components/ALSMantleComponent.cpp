...
void UALSMantleComponent::BeginPlay()
{
	...
	if (GetOwner())
	{
		OwnerCharacter = Cast<ARPGCharacter>(GetOwner());
		if (OwnerCharacter)
		{
                                        ...
                                        FActorComponentTickFunction* ThisTickFunction)
{
	...
	//if (OwnerCharacter && OwnerCharacter->)
	//{
                                      ...
                                      EALSMantleType MantleType)
{
    ...
    const FALSMantleAsset MantleAsset = GetMantleAsset(MantleType, EALSOverlayState::Default);
